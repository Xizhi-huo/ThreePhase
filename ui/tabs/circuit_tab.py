...
class CircuitTabAPI(Protocol):
    ...
    def get_pt_blackbox_mode(self) -> object: ...
...
class CircuitTab(QtWidgets.QWidget):
    ...
    def _draw_circuit_content(self):
        ...
        pt_blackbox_mode = self._api.get_pt_blackbox_mode()
        ...
        def _mk(blank, bbox, hdr=None, fontsize=6.5, row_labels=False):
            ...
            nc = len(h)
            t = ax.table(cellText=[list(r) for r in blank], colLabels=h, bbox=bbox, cellLoc="center")
    ...
    def _sidebar_label(self, name: str) -> QtWidgets.QLabel:
